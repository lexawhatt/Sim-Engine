...
use super::{
    Arc, Camera3dUniform, Mesh3d, Mesh3dRenderError, Mesh3dSurfaceError, MeshColorGpu, Object3dId,
    Scene3d, ShaderValueRange, SurfaceLightingVertex, SurfaceRasterization3d, SurfaceTransport,
    clip_plane_ranges, interval_lerp_range, is_portable_shader_source, material,
    rounded_f32_add_range, shader_clip_point_ranges, validate_edge_projection,
    validate_mesh_identity, validate_points_for_policy, validate_projected_triangle_orientation,
    validation, wgsl_signed_division_range,
};
...
#[cfg(test)]
pub(super) use tests::{
    assert_gpu_clipped_recovery, assert_gpu_native_edge_validation,
    assert_gpu_native_surface_policy, assert_gpu_offscreen_culling,
    assert_gpu_offscreen_culling_recovery, assert_gpu_preflight_scratch,
    assert_gpu_source_cache_contract, assert_gpu_surface_contract, test_read_pixels, test_target,
};
