...
use super::{
    Color, GlyphAtlas2d, GlyphAtlasBudget, GlyphAtlasEntry, GlyphId, GlyphRun2d, ImageBatchBudget,
    ImageTexelRect, LogicalScreenPosition, LogicalViewport, LogicalViewportRegion,
    PositionedGlyph2d, WgpuRenderer, glyph, image,
};
...
///
/// Draw [`Self::atlas`] and [`TextRun2d::glyph_run`] with [`ImageSampling::Linear`](crate::ImageSampling::Linear).
