...
cargo run --release --example rendering_benchmark_suite -- --fixture ui_static_10k
cargo run --release --example rendering_benchmark_suite -- --fixture ui_90_10
cargo run --release --example rendering_benchmark_suite -- --fixture four_viewports
cargo run --release --example rendering_benchmark_suite -- --fixture image_atlas
cargo run --release --example rendering_benchmark_suite -- --fixture scientific_text
...
cargo run --release --example rendering_benchmark_suite -- --fixture hidpi_resize
